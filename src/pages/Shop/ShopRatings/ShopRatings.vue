          ...
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                ...
                <span class="item" v-if="rating.recommend.length" v-for="(recommend,index) in rating.recommend" :key="index">{{recommend}}</span>
              </div>
  ...
  export default {
    ...
    computed:{
      ...
      filterRatings(){
        ...
        //   if (selectType === item.rateType){
        //     if (onlyText&&item.text) {
        //       result.push(item)
        //     }else if (!onlyText){
        //       result.push(item)
        //     }
        ...
        return ratings.filter(rating=>{
          return (selectType===2||selectType===rating.rateType)&&(!onlyText||rating.text)
        })
