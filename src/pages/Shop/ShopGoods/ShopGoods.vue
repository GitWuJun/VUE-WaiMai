...
<script>
  ...
  export default {
    ...
    data() {
      return {
        scrollY: 0,//右侧滑动的Y轴坐标(随着滑动实时变化)
        tops: [],//所有右侧分类li的top组成数组(列表第一次显示后就不再变化)
        foodsScroll:'',
        food:{},//需要展示的food
    ...
    computed: {
      ...
      currentIndex() {
        ...
        //   if (tops[i]<=scrollY&&tops[i+1]>=scrollY){
        //
        //     return i
        //   }
        // }
    ...
    methods: {
      clickMenuItem(index){
       //使右侧列表滑动到对应位置
        ...
        this.foodsScroll.scrollTo(0,-this.scrollY,200)
      },
